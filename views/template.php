...
<html lang="en" class="light scroll-smooth" dir="ltr">
    <head>
        <meta charset="UTF-8">
        <title>HabiTrack - PHP Real Estate Landing & Admin Dashboard Template</title>
    ...
    <script src="https://cdn.tailwindcss.com"></script>
        ...
        <div class="page-wrapper toggled">
            <main class="page-content bg-gray-50 dark:bg-slate-800">
                ...
                <!-- navbar file -->
                <?php
                    include __DIR__ ."/modules/navbar.php";
                ?>
        ...
        <?php
            if (isset($route)) {
                $routeScripts = [
                    ...
                    "login" => ["login.js"],
                    "add-property" => ["add-property.js"]  //added 050726
                    
                ];

                    if (array_key_exists($route, $routeScripts)) {
                        foreach ($routeScripts[$route] as $script) {
                        $scriptPath = __DIR__ . "/js/" . $script;
                        if (file_exists($scriptPath)) {
                            echo '<script src="/habitrack/views/js/' . $script . '"></script>';
                        }
                    }
                }
            }
