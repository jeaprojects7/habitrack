...
require_once __DIR__ . "/../../models/agent.model.php"; //added 51626
require_once __DIR__ . "/../../controllers/agent.controller.php"; //added 51626
...
<form class="text-start" method="POST">
    <div class="grid grid-cols-1">
        ...
        <div class="mb-4">
            ...
            <input name="agentLoginEmail" id="agentLoginEmail" type="text" class="form-input mt-3" placeholder="Enter Email">
        </div>

        <div class="mb-4">
            <label class="font-medium">Password:</label>
            <input name="agentLoginPass" id="agentLoginPass" type="password" class="form-input mt-3" placeholder="Enter Password">
        </div>
        ...
        <div class="mb-4">
            ...
            <button type="button" id="btn-agent-login"
