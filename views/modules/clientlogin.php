...
require_once __DIR__ . "/../../models/clientsignup.model.php"; //added 51626
...
<form class="text-start" method="POST">
    <div class="grid grid-cols-1">
        ...
        <div class="mb-4">
            ...
            <input name="clientLoginEmail" id="clientLoginEmail" type="text" class="form-input mt-3" placeholder="Enter Email">
        </div>

        <div class="mb-4">
            <label class="font-medium">Password:</label>
            <input name="clientLoginPass" id="clientLoginPass" type="password" class="form-input mt-3" placeholder="Enter Password">
        </div>
