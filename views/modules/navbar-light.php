            ...
            <div class="container relative">
                ...
                <a class="logo" href="home.php">
                    <span class="inline-block dark:hidden">
                        <img src="<?php echo $static_url; ?>/images/logo-dark.png" class="l-dark" height="24" alt="">
                        <img src="<?php echo $static_url; ?>/images/logo-light.png" class="l-light" height="24" alt="">
                    </span>
                    <img src="<?php echo $static_url; ?>/images/logo-light.png" height="24" class="hidden dark:inline-block" alt="">
                </a>
                <!-- End Logo container-->
                        ...
                        <li class="has-submenu parent-parent-menu-item">
                            ...
                            <ul class="submenu megamenu">
                                <li>
                                    <ul>
                                        <li>
                                            <a href="home.php" class="sub-menu-item">
                                        ...
                                        <li>
                                            <a href="home-two.php" class="sub-menu-item">
                                                <div class="lg:text-center">
                                ...
                                <li>
                                    <ul>
                                        <li>
                                            <a href="home-three.php" class="sub-menu-item">
                                                <div class="lg:text-center">
                                        ...
                                        <li>
                                            <a href="home-four.php" class="sub-menu-item">
                                                <div class="lg:text-center">
                                ...
                                <li>
                                    <ul>
                                        <li>
                                            <a href="home-five.php" class="sub-menu-item">
                                                <div class="lg:text-center">
                                        ...
                                        <li>
                                            <a href="home-six.php" class="sub-menu-item">
                                                <div class="lg:text-center">
                                ...
                                <li>
                                    <ul>
                                        <li>
                                            <a href="home-seven.php" class="sub-menu-item">
                                                <div class="lg:text-center">
                                        ...
                                        <li>
                                            <a href="home-eight.php" class="sub-menu-item">
                                                <div class="lg:text-center">
                                ...
                                <li>
                                    <ul>
                                        <li>
                                            <a href="home-nine.php" class="sub-menu-item">
                                                <div class="lg:text-center">
                                        ...
                                        <li>
                                            <a href="home-ten.php" class="sub-menu-item">
                                                <div class="lg:text-center">
